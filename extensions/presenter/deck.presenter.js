$(function() {
    ...
    function updateNotes() {
        var notes = $("section .notes"),
                currentNotes = $current("section.deck-current .notes").html();
        if (!empty(currentNotes)) { // If there is a note to update update it
...
// This function checks if a variable has a value or is empty
